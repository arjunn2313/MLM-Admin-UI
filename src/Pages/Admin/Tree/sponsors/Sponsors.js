                    ...
                    >
                      ...
                      {member?.isHead ? (
                        <>
                          ...
                          <td className="p-2 text-left">NA</td>
                        </>
                      ) : (
                        <>
                      ...
                      <td
                        ...
                        onClick={() =>
                          navigate(
                            `?tab=Sponsors&tree=sponsortree&memberId=${member?.memberId}&memberName=${member?.name}&sponsorId=${member?.sponsorId}&headName=${member?.sponsorName}`
                          )
                        }
                      >
                        <img
