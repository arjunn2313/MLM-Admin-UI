  ...
  const fetchSectionData = async () => {
    ...
    try {
      const response = await axios.get(
        `${BaseUrl}/api/admin/section/downline-members/${treeName}`,
        {
          params: {
            search: searchQuery,
            page: currentPage,
                  ...
                  members.map((member, index) => (
                    ...
                    >
                      ...
                      <td
                        ...
                        onClick={() =>
                          navigate(
                            `?tab=DownlineMember&tree=downlinetree&memberId=${member?.memberId}&memberName=${member?.name}&sponsorId=${member?.sponsorId}&headName=${member?.sponsorName}`
                          )
                        }
                      >
                        <img
