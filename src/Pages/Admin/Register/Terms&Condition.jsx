        ...
        <div className="space-y-8">
          <section className="space-y-3">
            ...
            <p className="text-gray-800  ">
              ...
              advised to stop using the website accordingly. SIP only
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-800">
              ...
              Agreement. SIP assumes no responsibility for
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-800">
              ...
              this website are the property of SIP, its affiliates,
              ...
              reproduce or redistribute the SIP's intellectual
              property in any way, including electronic, digital, or new
              trademark registrations. You grant SIP a royalty-free
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-800">
              ...
              might come between SIP and you, or its business
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-800">
              You agree to indemnify SIP and its affiliates and hold
              SIP harmless against legal claims and demands that may
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-800">
              SIP is not liable for any damages that may occur to you
              as a result of your misuse of our website. SIP reserves
              ...
              mail. This Agreement is an understanding between SIP
